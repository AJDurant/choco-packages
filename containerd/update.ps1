...
$name64 = "containerd-windows-amd64.tar.gz"
$releaseUrl = "https://api.github.com/repos/containerd/containerd/releases/latest"
...
function global:au_GetLatest {
    ...
    $jsonAnswer.assets | where { $_.name -match "^containerd-[0-9.]+-windows-amd64.tar.gz$" } | ForEach-Object {
